public class AccountOverdrawSafeDemo implements Runnable {
    ...
    public static void main(String[] args) {
        ...
        AccountOverdrawSafeDemo job = new AccountOverdrawSafeDemo();
        //Making a job
    ...
    //Here, the method is made synchronized
    //It means only one thread can access it at a time,which solves the previous problem!!
    private synchronized void makeWihdrawal(int amount) {
